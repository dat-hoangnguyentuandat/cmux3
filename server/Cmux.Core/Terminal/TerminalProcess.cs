...
public sealed class TerminalProcess : IDisposable
{
        ...
        Dictionary<string, string>? extraEnv = null)
    {
        ...
        // Build environment block if extra vars provided
    ...
    private static IntPtr BuildEnvironmentBlock(Dictionary<string, string> extraEnv)
    {
        // Start with current process environment, overlay with extras
        ...
        // Build null-terminated KEY=VALUE\0 block ending with \0\0
