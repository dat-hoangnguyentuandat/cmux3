...
public class SessionPersistenceService
{
    ...
    public static SessionState BuildState(
        ...
        IReadOnlyList<ToolPanelLayout>? toolPanels = null,
        IReadOnlyList<DockGroupSize>? dockGroups = null,
        bool agentChatVisible = true, bool terminalVisible = true)
    {
        var state = new SessionState
        {
            ...
            Window = new WindowState
            {
                ...
                AgentChatVisible = agentChatVisible,
                TerminalVisible = terminalVisible,
                CompactSidebar = compactSidebar,
                ToolPanels = toolPanels?.ToList() ?? [],
                DockGroups = dockGroups?.ToList() ?? [],
            },
        };
