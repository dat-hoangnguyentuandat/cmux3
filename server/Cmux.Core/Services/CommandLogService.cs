...
/// Completed commands are persisted to daily JSONL files under %LOCALAPPDATA%/cmux2/logs.
/// </summary>
public class CommandLogService
{
    ...
    private static readonly string LogsDir = Path.Combine(
        Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData), "cmux2", "logs");
