...
/// Settings are stored at <c>%LOCALAPPDATA%/cmux2/settings.json</c>.
/// </summary>
public static class SettingsService
{
    private static readonly string SettingsDir =
        Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData), "cmux2");
    ...
    private static void MigrateClaudibleToCustomProvider(CmuxSettings settings)
    {
