...
/// <summary>
/// Hides the launcher to the Windows system tray while keeping the cmux3 host
...
internal static class Tray
{
    internal static void Run()
    {
        ...
        icon.ShowBalloonTip(2000, "cmux3", $"Running in the background at {ServerManager.Url}",
            ToolTipIcon.Info);
