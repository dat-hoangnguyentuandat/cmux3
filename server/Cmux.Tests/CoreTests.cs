...
public class SplitNodeTests
{
    ...
    {
        var node = Cmux.Core.Models.SplitNode.CreateLeaf("a");
        var newChild = node.Split(Cmux.Core.Models.SplitDirection.Vertical);
    ...
    public void MovePaneToEdge_SameId_ReturnsFalse()
    {
        ...
        var result = node.MovePaneToEdge("a", "a", Cmux.Core.Models.SplitDirection.Horizontal, sourceFirst: true);
    ...
    public void MovePaneToEdge_SplitsTargetAndPreservesPaneIds()
    {
        ...
        var result = node.MovePaneToEdge("a", bId, Cmux.Core.Models.SplitDirection.Horizontal, sourceFirst: true);
        ...
        bContainer.Direction.Should().Be(Cmux.Core.Models.SplitDirection.Horizontal);
    ...
    public void MovePaneToEdge_SourceFirstFalse_PutsMovedPaneSecond()
    {
        ...
        var result = node.MovePaneToEdge("a", bId, Cmux.Core.Models.SplitDirection.Horizontal, sourceFirst: false);
    ...
    public void MovePaneToEdge_MissingTarget_ReturnsFalse()
    {
        ...
        var result = node.MovePaneToEdge("a", "does-not-exist", Cmux.Core.Models.SplitDirection.Horizontal, sourceFirst: true);

        result.Should().BeFalse();
    }

    // Helper: finds the non-leaf node whose First or Second child has the given PaneId.
    private static Cmux.Core.Models.SplitNode? FindContainerWithPaneId(Cmux.Core.Models.SplitNode root, string paneId)
    {
